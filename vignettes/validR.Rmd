...
col_tests <- do.call("rbind", lapply(tests_all, test_summary, df = df))

issues <- do.call("rbind", lapply(tests_all, wrong_rows, df = df))
```
...
merge_test1 <- test_summary(test1, primary_df, related_df)
issues1 <- wrong_rows(test1, primary_df, related_df)
...
merge_test2 <- test_summary(test2, primary_df, related_df)
issues2 <- wrong_rows(test2, primary_df, related_df)
