...
testthat::test_that("tests test_unique evaluates correctly", {
    ...
    testthat::expect_equal(test_unique(vec1)[2], test_pass_ti)
    
    testthat::expect_equal(length(test_unique(vec2)), 3)
    testthat::expect_equal(test_unique(vec2)[2], test_fail_ti)
...
testthat::test_that("tests test_values_test evaluates correctly", {
    ...
    testthat::expect_equal(test_values(vec2, expc_values)[2], test_pass_ti)
    
    testthat::expect_equal(length(test_values(vec1, expc_values)), 3)
    testthat::expect_equal(test_values(vec1, expc_values)[2], test_fail_ti)
...
testthat::test_that("tests test_null_values evaluates correctly", {
    ...
    testthat::expect_equal(test_null_values(vec1)[2], test_pass_ti)
    
    testthat::expect_equal(length(test_null_values(vec3)), 3)
    testthat::expect_equal(test_null_values(vec3)[2], test_fail_ti)
